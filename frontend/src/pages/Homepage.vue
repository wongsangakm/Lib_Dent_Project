<template>
  ...
  <Header />
      ...
      >
        ...
        <div class="md:w-1/2 text-center md:text-left">
          ...
          <div class="">
            ...
            <p class="text-gray-600 text-center">
              We welcome your recommendations and will consider them to support
    ...
    <section id="searchbook" class="scroll-mt-24 container mx-auto px-4 mt-8 rounded-3xl bg-white/50">
              ...
              <div class="relative">
                <router-link :to="`/book/${book.id}`">
                  <img
                    :src="book.coverImage"
                    alt="Book Cover"
                    class="rounded-lg shadow-md hover:shadow-lg transition-shadow w-[150px]"
                  />
                </router-link>
                <button
      ...
      <div class="container mx-auto px-4">
        ...
        <div class="flex items-center space-x-2">
          ...
          <button
            v-if="showLeftArrow"
            @click="scrollLeft"
            class="bg-purple-600 text-white rounded-full p-2 hover:bg-purple-700 transition-colors"
          >
            <svg
              class="w-5 h-5"
              fill="none"
